export default function Profile({}) {
  return (
    <div id="profile" className="flex flex-col justify-center items-center">
      ...
      ></div>
      <div className="flex flex-col px-5 gap-y-3 text-2xl max-w-md md:max-w-lg font-heading text-center text-queenBlue">
        <p>
          {"Hi there, I'm "}
      ...
      <div className="flex my-10 md:my-14 gap-x-12">
        <a
          href="https://www.github.com/knotuteye"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="https://www.gitlab.com/kevinotuteye"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/kevinotuteye/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
